...
versions   = ['base', 'PE']
versions_to_text = {'base': 'Base','PE': 'Prompt Eng'}
categories = [
...
output_dir = 'plots/2_version_comparison_with_box_signif'
    ...
    for model in models:
        ...
        for ver in versions:
            ...
            for cat in categories:
                raw[lang]['category'][model][cat][ver] = (
                    sub.loc[sub['category']==cat, 'final_score'].dropna().tolist())
...
for lang in languages:
    ...
    ax.set_title(f'Base and Prompt Eng Comparison in {languages_to_text[lang]} for All Models', fontsize=14)
    ax.set_xticks(x)
    ...
    for model in models:
        ...
        ax.set_title(f'Base and Prompt Eng Comparison in {languages_to_text[lang]} for Model: {models_to_text[model]}', fontsize=14)
