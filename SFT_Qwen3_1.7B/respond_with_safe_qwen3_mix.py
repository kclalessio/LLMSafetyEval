...
def load_finetuned_model(base_model_id = "Qwen/Qwen3-1.7B", adapter_dir = "Qwen3-1.7B_safety_mix_qlora",):
...
if __name__ == "__main__":
    ...
    OUTPUT_PATH = "dataset/safe_qwen3_mix_250_responses_en.xlsx"
    PROG_FILE = "safe_qwen3_mix_progress_en.txt"
    # QUESTIONS_PATH = "dataset/harmful_question_clean_it_250_ts.xlsx"
    # OUTPUT_PATH = "dataset/safe_qwen3_en_it_250_responses_it.xlsx"
    # PROG_FILE = "safe_qwen3_en_it_progress_it.txt"
