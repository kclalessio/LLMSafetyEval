...
def main():
    ...
    OUTPUT_DIR = "gemma3-1b-it_safety_en_qlora"
    ...
    ds_full = load_dataset("gretelai/gretel-safety-alignment-en-v1", split="train")
    ...
    # trainer.train()
    trainer.train(resume_from_checkpoint="gemma3-1b-it_safety_en_qlora/checkpoint-2000")
