...
def load_model(base_model_id = "google/gemma-3-1b-it",):
...
if __name__ == "__main__":
    ...
    OUTPUT_PATH = "dataset/gemma3_1b_250_responses_en.xlsx"
    PROG_FILE = "gemma3_1b_en_progress.txt"
    # QUESTIONS_PATH = "dataset/harmful_question_clean_it_short_ts.xlsx"
    # OUTPUT_PATH = "dataset/gemma3_1b_short_responses_it.xlsx"
    # PROG_FILE = "gemma3_1b_it_progress.txt"
