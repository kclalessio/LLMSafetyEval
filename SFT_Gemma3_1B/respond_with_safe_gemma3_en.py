...
def load_finetuned_model(base_model_id = "google/gemma-3-1b-it",adapter_dir = "gemma3-1b-it_safety_en_qlora",):
...
if __name__ == "__main__":
    ...
    OUTPUT_PATH = "dataset/safe_gemma3_1b_en_250_responses_en.xlsx"
    PROG_FILE = "safe_gemma3_1b_en_progress_en.txt"
    # QUESTIONS_PATH = "dataset/harmful_question_clean_it_250_ts.xlsx"
    # OUTPUT_PATH = "dataset/safe_gemma3_1b_en_250_responses_it.xlsx"
    # PROG_FILE = "safe_gemma3_1b_en_progress_it.txt"
