...
def load_finetuned_model(base_model_id = "meta-llama/Llama-3.2-3B-Instruct",adapter_dir = "Llama_3.2_3B_safety_mix_qlora",):
...
if __name__ == "__main__":
    ...
    OUTPUT_PATH = "dataset/safe_llama3_mix_250_responses_en.xlsx"
    PROG_FILE = "safe_llama3_mix_progress_en.txt"
    # QUESTIONS_PATH = "dataset/harmful_question_clean_it_250_ts.xlsx"
    # OUTPUT_PATH = "dataset/safe_llama3_mix_250_responses_it.xlsx"
    # PROG_FILE = "safe_llama3_mix_progress_it.txt"
